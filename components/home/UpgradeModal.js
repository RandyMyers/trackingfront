  ...
  return (
    <Overlay>
      <ModalContainer>
        ...
        <ModalText>Your trial period has ended. Upgrade to a premium plan to continue using the service.</ModalText>
        <RenewButton onPress={handleUpgrade}>
          <RenewButtonText>Upgrade Plan</RenewButtonText>
        </RenewButton>
      </ModalContainer>
    </Overlay>
  );
