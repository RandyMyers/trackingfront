...
import { createPaymentAction } from '../store/actions/paymentActions';

const CashappBillingScreen = ({ navigation }) => {
    ...
    console.log( 'paymentDetails', paymentMethod.paymentLinks );
    ...
    const handleContinue = async () => {
        ...
        const paymentData = {
            ...
            paymentLinks: paymentMethod.paymentLinks, 
        ...
        navigation.navigate('CashappCheckout', { paymentData });
    };
...
export default CashappBillingScreen;
