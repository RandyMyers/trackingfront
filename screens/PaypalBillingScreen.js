...
import { createPayPalIntentAction, createPaymentIntentAction } from '../store/actions/paymentActions';
...
const PaypalBillingScreen = ({ navigation }) => {
    ...
    const handleContinue = async () => {
        ...
        await dispatch(createPayPalIntentAction(paymentData));
...
export default PaypalBillingScreen;
